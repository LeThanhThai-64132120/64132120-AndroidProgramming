...
public class MainActivity extends AppCompatActivity {
    ...
    Button buttonCau1, buttonCau2, buttonCau3, buttonCau4, buttonLamThem;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonLamThem = findViewById(R.id.btnLamThem);
        ...
        buttonLamThem.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
